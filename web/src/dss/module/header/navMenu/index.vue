    ...
    <div class="nav-menu-item" v-for="item in menuList" :key="item.id">
      ...
      <div class="menu-item-content">
        <div
          ...
          v-for="app in item.appInstances"
          :key="app.id"
          class="cont-item"
        >
          <span>{{ app.title }}</span>
      ...
      <template v-for="(item, index) in menuList">
        ...
        >
          ...
          <Icon
            ...
            v-if="item.appInstances"
          ></Icon>
        </div>
      </template>
    </div>
    <div class="nav-menu-right" v-if="current">
      <div class="nav-menu-right-item" :key="current.id">
        ...
        >
          <SvgIcon
            ...
            :icon-class="iconSplit(item.icon)[0]"
            :color="iconSplit(item.icon)[1]"
          />
