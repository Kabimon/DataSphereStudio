...
public interface TableColumnCountQueryMapper extends BaseMapper<TableColumnCount> {
    ...
    String querySql = "select tbl_db.db_name as db_name,tbl_db.tbl_name as tbl_name,tbl_db.tbl_id as tbl_id , count(*) as column_count \n" +
            ...
            "    right join (select t.TBL_NAME as tbl_name,t.TBL_ID as tbl_id, s.CD_ID as cd_id ,d.DB_ID as db_id ,d.NAME as db_name from  TBLS as t left join SDS as s on t.SD_ID = s.SD_ID left join DBS d on t.DB_ID = d.DB_ID and t.TBL_TYPE='MANAGED_TABLE') as tbl_db\n" +
